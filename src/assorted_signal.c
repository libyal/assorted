...
void (*assorted_signal_signal_handler)( assorted_signal_t ) = NULL;
...
{
	static char *function = "assorted_signal_handler";
	...
	switch( signal )
	{
		...
		case CTRL_C_EVENT:
			if( assorted_signal_signal_handler != NULL )
			{
				assorted_signal_signal_handler(
				 signal );
			}
			return( TRUE );
...
{
	static char *function = "assorted_signal_attach";
	...
	assorted_signal_signal_handler = signal_handler;

	if( SetConsoleCtrlHandler(
	     assorted_signal_handler,
	     TRUE ) == 0 )
	{
		libcerror_error_set(
		 error,
...
#if defined( _MSC_VER )
	assorted_signal_initialize_memory_debug();
#endif
...
int assorted_signal_detach(
     libcerror_error_t **error )
{
	static char *function = "assorted_signal_detach";
	...
	assorted_signal_signal_handler = NULL;
