...
$LocalLibs = "libcdata libcerror libcfile libclocale libcnotify libcthreads libfcrypto libfdatetime libfguid libfplist libfvalue libfwevt libfwnt libhmac libuna"
