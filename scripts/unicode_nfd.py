#!/usr/bin/python
# -*- coding: utf-8 -*-
"""Script to export Unicode NFD decomposition mappings based on Python."""
...
def Main():
  ...
  argument_parser = argparse.ArgumentParser(description=(
      'Exports Unicode NFD decomposition mappings based on Python.'))
  ...
  for unicode_character, last_unicode_character in unicode_character_ranges:
    print((
        'libfsapfs_name_decomposition_mapping_t '
        'libfsapfs_name_decomposition_mappings_0x{0:08x}[ {1:d} ] = {{').format(
  ...
  for unicode_character, last_unicode_character in unicode_character_ranges:
    ...
    output_string = (
        ...
        '\t\t{{\n'
        '\t\t\tnfd_mapping = libfsapfs_name_decomposition_mappings_0x{0:08x}[ '
        'unicode_character - 0x{0:08x}UL ];\n'
