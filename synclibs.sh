...
LOCAL_LIBS="libcdata libcerror libcfile libclocale libcnotify libcthreads libfcrypto libfdatetime libfguid libfmos libfplist libfvalue libfwevt libfwnt libhmac libuna";
