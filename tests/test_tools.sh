...
LIBRARY_TESTS="adc adler32 ascii7 bit_stream bzip crc32 crc64 deflate fletcher32 fletcher64 huffman_tree lzfse lzfu lzma lzvn xor32 xor64";
...
run_test()
{
	...
	local TEST_EXECUTABLE="./assorted_test_${TEST_NAME}";
