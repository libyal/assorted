...
$ToolsTests = "adler32 ascii7 bit_stream bzip crc32 crc64 deflate fletcher32 fletcher64 huffman_tree lzfu lzma xor32 xor64"
$ToolsTestsWithInput = ""
...
Function RunTest
{
	...
	$TestExecutable = "${TestExecutablesDirectory}\orted_test_tools_${TestName}.exe"
...
Function RunTestWithInput
{
	...
	$TestProfileDirectory = GetTestProfileDirectory "input" "assorted"
